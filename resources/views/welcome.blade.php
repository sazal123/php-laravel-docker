...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        ...
        document.getElementById('fb-login-btn').addEventListener('click', function() {
            FB.login(handleLoginResponse, {scope: 'pages_show_list,leads_retrieval, pages_manage_metadata,pages_manage_ads,ads_management,ads_read,pages_read_engagement'});
        });
    </script>
    </body>
</html>
